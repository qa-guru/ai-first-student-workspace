...
sheets = [
    ("00-overview", "00 · Общая карта", "четыре вопроса · чайник = автотест на логин · quiz"),
    ...
    ("04-adr", "04 · ADR", "почему A не B · 005 · 006"),
    ...
    ("24-login-adr", "24 · без ADR / с ADR", "e2e на 401 vs api + slice"),
