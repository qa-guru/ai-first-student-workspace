...
.hl-method,.hl-header-name{color:#0d9488;font-weight:600}
...
<#if data.curl??>
<h4 style="margin:8px 0 4px;font-size:12px;opacity:.7">Curl</h4>
<div><pre style="margin:0;overflow:visible;background:transparent"><code class="hl-curl" style="display:block;padding:0;background:transparent;color:inherit;font-family:ui-monospace,monospace;font-size:13px;white-space:pre-wrap;overflow:visible">${data.curl}</code></pre></div>
</#if>
<script>
(function(){
...
function curl(el){
  ...
  el.innerHTML=h.replace(/\b(POST|GET|PUT|DELETE|PATCH|HEAD)\b/g,'<span class="hl-method" style="color:#0d9488;font-weight:600">$1</span>').replace(/'([^'\\]|\\.)*'|"([^"\\]|\\.)*"/g,function(m){return'<span class="hl-url" style="color:#db2777">'+e(m)+'</span>'});
}
